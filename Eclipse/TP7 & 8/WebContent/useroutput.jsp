<%@ page language="java" import="beans.UserinputForm" contentType="text/html; charset=ISO-8859-1"
...
<body>
      ...
      <html:button property="add"
        onclick="location.href='afficherProfesseurs.do'">Afficher la liste des professeurs
      </html:button>
